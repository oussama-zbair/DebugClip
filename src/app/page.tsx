    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 py-24">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.3, duration: 0.6 }}
          ...
          <a href="https://microsoftedge.microsoft.com/addons/detail/debugclip" target="_blank" rel="noopener" className="btn-ghost opacity-70 cursor-not-allowed pointer-events-none">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.35, duration: 0.6 }}
          className="mt-6 flex items-center justify-center gap-5 text-xs text-ds-textMuted">
